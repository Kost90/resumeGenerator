  ...
  return (
    <div className={styles.side_bar}>
      <List component="ul" aria-label="mailbox folders">
        <ListItem>
          <ListItemText primary='User Firstname' secondary={loginusers.Firstname}/>
        </ListItem>
        <Divider />
        <ListItem>
          <ListItemText primary='User Lastname' secondary={loginusers.Lastname}/>
        </ListItem>
        <Divider />
        <ListItem>
      ...
      <Typography variant='h6' sx={{textAlign:'center', color:'#2070c1'}}>Resume history:</Typography>
      <ResumeList />
